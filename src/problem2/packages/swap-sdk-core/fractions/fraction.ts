...
const toSignificantRounding: Record<Rounding, BigNumber.RoundingMode> = {
...
export class Fraction {
  ...
  public toSignificant(
    ...
    const rounded = new BigNumber(this.numerator.toString())
      .div(this.denominator.toString())
      .sd(significantDigits, toSignificantRounding[rounding])
    const dp = rounded.dp() ?? 0
    return rounded.toFormat(dp < 0 ? 0 : dp, toSignificantRounding[rounding], format as BigNumber.Format)
  }
